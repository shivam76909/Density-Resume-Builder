...
(function () {
  ...
  const validTemplates = ['cream', 'dark', 'modern', 'minimalist', 'monochrome', 'peach', 'teal', 'textual', '9', '10', '11', '12'];
  ...
  if (!document.getElementById('lp-styles')) {
    ...
    s.textContent = `
      ...
      .theme-modern .lp-container {
        ...
        background-image: url('img/mordern preview.png') !important;
      ...
      .theme-peach .lp-container {
        ...
        width: 100% !important;
        height: 100% !important;
        background-image: url('img/creative preview.png') !important;
        background-size: 100% 100% !important;
        background-repeat: no-repeat !important;
        background-position: center !important;
        overflow: hidden !important;
      ...
      .theme-9 .lp-container {
        ...
        width: 100% !important;
        height: 100% !important;
        background-image: url('img/corporate preview.png') !important;
        background-size: 100% 100% !important;
        background-repeat: no-repeat !important;
        background-position: center !important;
        overflow: hidden !important;
      ...
      .theme-12 .lp-container {
        ...
        width: 100% !important;
        height: 100% !important;
        background-image: url('img/artistic preview.png') !important;
        background-size: 100% 100% !important;
        background-repeat: no-repeat !important;
        background-position: center !important;
        overflow: hidden !important;
      ...
      .theme-10 .lp-container {
        ...
        width: 100% !important;
        height: 100% !important;
        background-image: url('img/elite preview.png') !important;
        background-size: 100% 100% !important;
        background-repeat: no-repeat !important;
        background-position: center !important;
        overflow: hidden !important;
      ...
      .theme-monochrome .lp-container {
        ...
        width: 100% !important;
        height: 100% !important;
        background-image: url('img/monochrome preview.png') !important;
        background-size: 100% 100% !important;
        background-repeat: no-repeat !important;
        background-position: center !important;
        overflow: hidden !important;
      ...
      .theme-cream .lp-container {
        ...
        width: 100% !important;
        height: 100% !important;
        background-image: url('img/cream preview.png') !important;
        background-size: 100% 100% !important;
        background-repeat: no-repeat !important;
        background-position: center !important;
        overflow: hidden !important;
  ...
  function getLayoutType(id) {
    ...
    if (id === 'dark' || id === 'teal') return 'sidebar';
    return 'single'; // textual, 11
  }
      ...
      <div class="lp-container">
        ...
        <div class="lp-avatar-container" style="position: absolute; left: 2.5%; top: 4%; z-index: 10; display: flex;">
          <div class="lp-avatar" style="width: 75px; height: 75px; border-radius: 50%; border: 1px solid #1a1a1a; background: #ffffff; display: flex; align-items: center; justify-content: center; overflow: hidden; position: relative; z-index: 2;">
            <img src="img/photo icon.png" alt="Avatar" class="lp-avatar-img" style="width: 100%; height: 100%; object-fit: cover; transform: scale(1.05);">
          </div>
        </div>
      </div>
    `;
      ...
      <div class="lp-container">
        ...
        <div class="lp-avatar-container" style="display: none; position: absolute; left: 20px; top: calc(20% - 35px); z-index: 10;">
          ...
          <div class="lp-avatar" style="width: 65px; height: 65px; border-radius: 50%; border: 2px solid #4a3e3d; background: #ffffff; display: flex; align-items: center; justify-content: center; overflow: hidden; position: relative; z-index: 2;">
            <img src="img/pic icon.png" alt="Avatar" class="lp-avatar-img" style="width: 100%; height: 100%; object-fit: cover;">
          </div>
        </div>
      </div>
    `;
      ...
      <div class="ed-container">
        <div class="ed-sidebar">
          <div class="ed-avatar-container">
            <div class="ed-avatar">
              <img src="img/pic icon.png" alt="Avatar" class="ed-avatar-img">
            </div>
          </div>
  ...
  function render() {
    ...
    const fn = val('firstName') ?? c.firstName ?? 'Shivam';
    const ln = val('lastName') ?? c.lastName ?? 'Rajoriya';
    const prof = val('profession') ?? c.profession ?? 'Web Developer';
    const email = val('email') ?? c.email ?? 'shivamrajoriya76909@gmail.com';
    const phone = val('phone') ?? c.phone ?? '+91 9301306891';
    const country = val('country') ?? c.country ?? 'India';
    const pin = val('pincode') ?? c.pincode ?? '474020';
    ...
    if (activeLayout === 'modern') {
      ...
      if (document.activeElement !== nameEl) {
        nameEl.textContent = `${fn} ${ln}`.trim() || 'Shivam Rajoriya';
      }
      if (document.activeElement !== profEl) {
        profEl.textContent = prof || 'Lead Cloud Engineer';
      }
      ...
      if (avatarContainer && avatarImg) {
        ...
        avatarImg.src = d.photo || 'img/photo icon.png';
      ...
      if (avatarContainer && avatarImg) {
        avatarContainer.style.display = 'flex';
        avatarImg.src = d.photo || 'img/pic icon.png';
        if (d.photo && d.photo.startsWith('data:')) {
          avatarImg.classList.add('custom-photo');
        } else {
          avatarImg.classList.remove('custom-photo');
      ...
      if (nameEl && document.activeElement !== nameEl) nameEl.textContent = `${fn} ${ln}`.trim() || 'Shivam Rajoriya';
      if (profEl && document.activeElement !== profEl) profEl.textContent = prof || 'Lead Cloud Engineer';
      ...
      if (document.activeElement !== nameEl) {
        nameEl.textContent = `${fn} ${ln}`.trim() || 'First Last Name';
      }
      if (document.activeElement !== profEl) {
        profEl.textContent = prof || 'Software Engineer';
      }
      if (document.activeElement !== sumEl) {
        sumEl.textContent = summary || '';
      }
      ...
      if (profEl && document.activeElement !== profEl) {
        profEl.textContent = prof || 'Marketing Assistant';
      }
      ...
      if (sumEl && document.activeElement !== sumEl) {
        sumEl.textContent = summary || 'To secure a dynamic role in marketing with a well-established organization where I can apply my skills and expertise to contribute to business expansion and success.';
      }
      ...
      if (expList) {
        ...
        if (!hasExp && !summary) {
          if (expSec) expSec.style.display = 'flex';
          const defaultExps = [
            { company: 'Acme Corporation', role: 'Marketing Manager', date: '2020 - Present', desc: 'Planned and implemented strategic marketing initiatives to enhance brand visibility and boost sales performance.' },
            { company: 'Global Industries', role: 'Marketing Coordinator', date: '2016 - 2020', desc: 'Supported the planning and execution of marketing campaigns aimed at promoting products and services effectively.' }
          ];
          defaultExps.forEach((exp, idx) => {
            const item = document.createElement('div');
            ...
            item.innerHTML = `
              <div style="display: flex; justify-content: space-between; align-items: baseline; line-height: 1.1; width: 100%;">
                <div style="font-size: 6.5px; color: #111111; font-family: 'Inter', sans-serif;">
                  <strong id="mini-exp-${idx}-company" class="mini-editable" contenteditable="true" placeholder="Company" style="font-weight: 700;">${exp.company}</strong>, 
                  <span id="mini-exp-${idx}-role" class="mini-editable" contenteditable="true" placeholder="Job Title" style="font-weight: 500;">${exp.role}</span>
                </div>
                <div id="mini-exp-${idx}-date" class="mini-editable" contenteditable="true" placeholder="Dates" style="font-family: 'Canva Sans', sans-serif; font-size: 5.5px; color: #444444;">${exp.date}</div>
              </div>
              <div id="mini-exp-${idx}-desc" class="mini-editable" contenteditable="true" placeholder="Description..." style="font-family: 'Canva Sans', sans-serif; font-size: 6px; color: #333333; line-height: 1.35; outline: none; border: none; white-space: pre-wrap;">${exp.desc}</div>
            `;
            expList.appendChild(item);
          });
        } else {
      ...
      if (eduList) {
        ...
        if (edu.length === 0) {
          ...
          const defaultEdus = [
            { school: 'Amity University', degree: 'Business Marketing', date: '2016 - 2020' }
          ];
          defaultEdus.forEach((e, idx) => {
            const item = document.createElement('div');
            item.style.cssText = 'display: flex; justify-content: space-between; align-items: baseline; width: 100%;';
            item.innerHTML = `
              <div style="font-size: 6.5px; color: #111111; font-family: 'Inter', sans-serif;">
                <strong id="mini-edu-${idx}-school" class="mini-editable" contenteditable="true" placeholder="University" style="font-weight: 700;">${e.school}</strong>, 
                <span id="mini-edu-${idx}-degree" class="mini-editable" contenteditable="true" placeholder="Degree" style="font-weight: 500;">${e.degree}</span>
              </div>
              <div id="mini-edu-${idx}-date" class="mini-editable" contenteditable="true" placeholder="Dates" style="font-family: 'Canva Sans', sans-serif; font-size: 5.5px; color: #444444;">${e.date}</div>
            `;
            eduList.appendChild(item);
          });
        } else {
      ...
      if (sList) {
        ...
        if (skills.length === 0) {
          ...
          const defaultSkills = [
            { name: 'Market Research', desc: 'Skilled in conducting detailed market research to understand customer needs, industry trends, and competitive landscapes.' },
            { name: 'Analytical Thinking', desc: 'Proficient in analyzing data and market trends to identify opportunities and support strategic decision-making.' },
            { name: 'Project Management', desc: 'Experienced in handling multiple projects simultaneously, with the ability to prioritize tasks and meet deadlines efficiently.' },
            { name: 'Tools & Technologies', desc: 'Hands-on experience with Microsoft Office, Google Analytics, and various social media platforms for marketing and performance tracking.' }
          ];
          defaultSkills.forEach((s, idx) => {
            const div = document.createElement('div');
            div.style.cssText = "display: flex; flex-direction: column; gap: 1px; width: 48%; margin-bottom: 4px; box-sizing: border-box;";
            div.innerHTML = `
              <strong id="mini-skill-${idx}-name" class="mini-editable" contenteditable="true" placeholder="Skill Name" style="font-family: 'Canva Sans', sans-serif; font-size: 6.5px; font-weight: 700; color: #111111;">${s.name}</strong>
              <span id="mini-skill-${idx}-desc" class="mini-editable" contenteditable="true" placeholder="Skill Detail..." style="font-family: 'Canva Sans', sans-serif; font-size: 6px; color: #333333; line-height: 1.35;">${s.desc}</span>
            `;
            sList.appendChild(div);
          });
        } else {
      ...
      document.getElementById('sc-name').textContent = `${fn} ${ln}`.trim() || 'John Doe';
      document.getElementById('sc-prof').textContent = prof || 'Software Engineer';
